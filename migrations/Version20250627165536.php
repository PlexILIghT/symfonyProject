 ...
 */
final class Version20250627165536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE deal_log (id INT AUTO_INCREMENT NOT NULL, stock_id INT NOT NULL, sell_portfolio_id INT NOT NULL, buy_portfolio_id INT NOT NULL, timestamp DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', price DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, INDEX IDX_9477FAFADCD6110 (stock_id), INDEX IDX_9477FAFAF07EB4B0 (sell_portfolio_id), INDEX IDX_9477FAFACFFCB9FB (buy_portfolio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
